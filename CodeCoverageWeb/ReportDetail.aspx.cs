...
namespace CodeCoverageWeb
{
    public partial class ReportDetail : System.Web.UI.Page
    {
        ...
        protected void ShowTotalReport()
        {
            ...
            NameSpaceGridView.Visible = false;
            ViewState["ID"] = null;
            ...
            if (ViewState["ReportPath"] != null)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        ReportGridView.DataSource = total;
        ...
        protected void ShowNameSpaceReport(string id)
        {
            try
            {
                ...
                ClassGridView.Visible = false;
                NoReportLabel.Visible = false;
                NameSpaceGridView.DataSource = xxx;
                NameSpaceGridView.DataBind();
        ...
        protected void NameSpaceData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                HyperLink hKLink = (HyperLink)e.Row.FindControl("hpLink");
        ...
        protected void MethodData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
